...
class OtomotoManager:
    ...
    def create_lists(self):
        ...
        if not self.one_drive_manager.is_list_folder_created():
            ...
            #
            list_check_need_to_edit_path = "/tmp/check_need_to_edit.txt"
            list_ready_to_create_path = "/tmp/ready_to_create.txt"
            list_invalid_quantity_path = "/tmp/invalid_quantity.txt"
            list_in_stock_path = "/tmp/in_stock.txt"
            list_out_of_stock_path = "/tmp/out_of_stock.txt"

            self.upload_list_to_onedrive(uploaded_list=in_stock, uploaded_list_path=list_in_stock_path)
            self.upload_list_to_onedrive(uploaded_list=out_of_stock, uploaded_list_path=list_out_of_stock_path)
